...
vistas a minorar esse problema, alguns projetos de pesquisa visam métodos de otimizar a
obtenção de registros. O projeto DELPo é um ótimo exemplo. Através de um algoritmo
\textit{modeor} que recebe um arquivo, registram-se ocorrências, lemas e flexões que
...
estirpados agora. Além disso, cada parte da implemetação agora está sendo feita com as ferramentas
...
mais de 50 \say{leis}, é um tanto trabalhoso que sigam-se todos eles, mas com certeza se trata de um bom
ponto de partida.
...
O moedor que há na aplicação atual é enorme e exige grande refatoração. Entretanto, como a bagunça é grande,
...
O passo 1 é o mais básico de todos e consistiu de uma conversa inicial com o professor Mário, coordenador e criador do
projeto DELPo. O professor Marco também me ajudou a entender alguns aspectos importantes do assunto. Entretanto, o
\citetalias{MN2} e o artigo de \cite{Mar:17} foram de grande ajuda para entender a diferença entre os lemas, e tornaram-se
