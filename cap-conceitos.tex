...
Segundo \cite[p.~613]{Rcook:09}, \citetalias{RoR} (ou só Rails) é o que há de melhor
...
\say{massinha de modelar} em questão de ferramenta javascript.
...
Quando uma aplicação Vue.js carrega no servidor, o processo leva um pouco mais de tempo na primeira
...
\citetalias{Jest}, de modo similar a RSpec, é uma ferramenta de testes para Javascript criada pela equipe do Fecaebook,
...
\say{contexto global} garantindo independêcia entre cada um. Para aumentar ainda mais a performance, testes
...
Há outros mais, e vale dizer que muitos desses pilares estão mencionados no texto de \cite{CCL}, como o que se refere
